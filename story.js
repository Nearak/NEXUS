...
NIGHTS.n2={
  ...
  hints:{
    ...
    mrq1:'حوّل التردد ببطء حتى تصفو الموجة ويعطيك LOCK — ثم «التقط الإشارة».',
...
const ST_BEATS={
  ...
  n2:{
    ...
    async finish(){
      ...
      await say('خلّد جهازك الليلة كما هو. يا راصد… سأتواصل معك عندما يهدأ كل شيء. (أعد تشغيل الجهاز لليلة التالية)');
    }
  }
};
